...
@Autonomous(name="ALT RF Center", group = "Test")
public class AlternateRedFarCenter extends LinearOpMode {
    private Robot robot;
    private RelicRecoveryVuMark pictograph = RelicRecoveryVuMark.UNKNOWN;
    private double DISTANCE_TO_RIGHT_COLUMN = 3;
    private double DISTANCE_TO_CENTER_COLUMN = 12;
    private double DISTANCE_TO_LEFT_COLUMN = 20;
