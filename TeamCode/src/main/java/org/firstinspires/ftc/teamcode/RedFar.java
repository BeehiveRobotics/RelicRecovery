...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        switch (pictograph) {
            case LEFT:
                if (isDistanceSane) {
                    robot.driveUntilDistance(robot.drive.STRAFING_PAST_CRYPTOBOX_SPEED, robot.drive.DISTANCE_TO_FAR_COLUMN);
                } else {
            ...
            case CENTER:
                if (isDistanceSane) {
                    robot.driveUntilDistance(robot.drive.STRAFING_PAST_CRYPTOBOX_SPEED, robot.drive.DISTANCE_TO_CENTER_COLUMN);
                } else {
            ...
            case RIGHT:
                if (isDistanceSane) {
                    robot.driveUntilDistance(robot.drive.STRAFING_PAST_CRYPTOBOX_SPEED, robot.drive.DISTANCE_TO_CLOSE_COLUMN);
                } else {
                    robot.drive.strafeLeft(robot.drive.STRAFING_PAST_CRYPTOBOX_SPEED, robot.drive.DEFAULT_MOVING_TOWARDS_CRYPTOBOX_DISTANCE_FAR_POSITION - robot.drive.CRYPTOBOX_COLUMNS_OFFSET_FAR + 3);
                }
        }
