...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        switch (pictograph) {
            ...
            case CENTER:
                ...
                break;
            case RIGHT:
                robot.drive.backward(robot.drive.MAX_SPEED, MOVE_TOWARDS_CRYPTOBOX_DISTANCE_BLUE_RECOVERY + robot.drive.CRYPTOBOX_COLUMNS_OFFSET_RECOVERY - robot.drive.DRIVE_OFF_BALANCE_BOARD_DISTANCE - 0.75);
                break;
        }
